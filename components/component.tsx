    ...
    <div className="flex-[0.9517] rounded-3xs bg-whitesmoke-100 box-border flex flex-col items-center justify-start py-[45px] pr-[34px] pl-[38px] gap-[30px] min-w-[292px] max-w-full text-center text-6xl text-gray-200 font-nunito border-[1px] border-solid border-gainsboro-200 mq450:gap-[30px] mq450:flex-1 mq850:pt-[29px] mq850:pb-[29px] mq850:box-border">
      <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[35px] pl-0">
        <div className="flex-1 flex flex-col items-center justify-start">
          <div className="flex flex-row items-start justify-start py-0 pr-6 pl-0">
            <h3 className="m-0 relative text-inherit leading-[110.5%] font-bold font-inherit mq450:text-xl mq450:leading-[22px]">
              Starter
            </h3>
          </div>
          <div className="self-stretch flex flex-row items-start justify-center gap-[34px] mt-[-3px] text-31xl mq450:flex-wrap mq450:gap-[34px]">
            <img
              className="h-[49px] w-[49px] relative object-cover"
              alt=""
              src="/img-2@2x.png"
            />
            <div className="flex-1 flex flex-col items-start justify-start pt-2.5 px-0 pb-0 box-border min-w-[128px]">
