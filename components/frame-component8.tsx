...
const FrameComponent8: NextPage = () => {
  ...
  return (
    <section className="self-stretch h-[606px] flex flex-row items-start justify-start py-0 pr-0 pl-px box-border max-w-full text-left text-11xl text-darkslategray-600 font-nunito">
      <div className="self-stretch flex-1 flex flex-col items-center justify-start py-[66px] pr-[35px] pl-5 box-border relative gap-[252px] max-w-full mq1225:gap-[252px] mq450:gap-[252px] mq850:gap-[252px] mq850:pt-[43px] mq850:pb-[43px] mq850:box-border">
        <img
